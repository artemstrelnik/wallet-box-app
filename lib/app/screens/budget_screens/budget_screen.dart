...
import 'package:wallet_box/app/core/generals_widgets/customBottomSheet.dart';
...
import '../../core/generals_widgets/button.dart';
...
class _BudgetScreenState extends State<BudgetScreen> with ScreenLoader {
  ...
  ContainerCustom _billEarnAndSpend() {
  ...
  Padding _bottomSheetButtons(
    ...
    return Padding(
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          final _bloc = context.read<BudgetScreenBloc>();
          ...
          if (index == 2) {
            ...
            String description = index == 0
                ? "Запланированный расход позволяет контролировать ваши операции по расходам. Для установки запланированного расхода введите сумму, которая будет означать ваш план по расходам на этот месяц."
